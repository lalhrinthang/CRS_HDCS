...
const sampleReports = [
  {
    ...
    category: "traffic_accident" as const,
    township: "Kamayut",
    latOffset: 0.003, lngOffset: -0.001,
  },
    {
    title: "Traffic congestion at Thaketa Junction",
    description: "Daily gridlock at Thaketa junction during rush hours. No traffic police present to manage flow.",
    category: "traffic_accident" as const,
    township: "Thaketa",
    latOffset: 0.003, lngOffset: -0.001,
  },
